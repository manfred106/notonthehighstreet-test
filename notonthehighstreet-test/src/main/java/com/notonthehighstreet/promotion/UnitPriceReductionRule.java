...
/**
 * UnitPriceReductionRule is an implementation class of PromotionRule. 
 * 
 * It is for handling the promotion rule of 
 * Buy more than x items, then the price drops to the predefined reduced price.
 * 
 * @author manfred
 *
 */
