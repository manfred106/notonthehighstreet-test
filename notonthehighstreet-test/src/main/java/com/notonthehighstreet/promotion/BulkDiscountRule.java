...
/**
 * BulkDiscountRule is an implementation class of PromotionRule. 
 * It defines the bulk discount rule -> spending over the minimum amount £, and getting a predefined % off.
 * 
 * @author manfred
 *
 */
